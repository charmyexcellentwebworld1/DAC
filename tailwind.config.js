...
module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      'left-arrow':"url('../dist/assets/images/blue-bg-arrow1.svg')",
      'right-arrow': "url('../dist/assets/images/blue-bg-arrow.svg')",
      ...
      'slider-after-img': 'linear-gradient(90deg, #283347 0%, #FFFFFF00 100%)',
      'car-zoom-blue-bg':'linear-gradient(204deg, #283347 0%, #FFFFFF00 30%)',
    },
    backgroundPosition: {
      '11px-50': '11px 50%',
    },
